...
function bindDataToHTML() {
	...
	if (typeof(data.then)  === 'function'){
		...
		for (var i = 0; i < data.products.length; i++) {
			mainRow.append('<div class="col-md-3" id='+ data.products[i].id+'><div class="card card-product card-plain"><div class="card-image">'
				+ '<a href="#" data-toggle="modal" data-target="#detailedDishes' + '-' + data.products[i].id + '">'
				+ '<img src="' + data.products[i].img + '" alt="Rounded Image" class="img-rounded img-responsive">'
				+ '</a>'
				+ '<div class="card-body text-center">'
				+ '	<div class="card-title">'
				+ '		<h5><b>' + data.products[i].name + '</b></h5>'
...
function bindDataToHTMLDetail() {
	...
	if (typeof(data.then)  === 'function'){
		let loadProducts = data.then(x => {
			for (var i = 0; i < x.products.length; i++) {
				mainRow.append(
					'<div class="modal fade" id="detailedDishes' + '-' + x.products[i].id + '" tabindex="-1" role="dialog" aria-labelledby="modalDetail" aria-hidden="true">'
				+ '<div class="modal-dialog modal-notice" style="max-width: 65%;">'
				+ '<div class="modal-content">'
				+	'<div class="modal-header no-border-header">'
				+		'<h3 class="modal-title" id="modalDetail"><b>'+ x.products[i].title +'</b></h3>'
				...
				+									'<a href='+ '"' + x.products[i].img1 + '"'+' itemprop="contentUrl" data-size="750x1050">'
				+									'<img src='+ '"' + x.products[i].img1 + '"'+' itemprop="thumbnail" alt="Image description 1" class="vertical-image img-rounded img-responsive" />'
				+									'</a>'
				+								'</figure>'
				+								'<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-4 col-sm-5 gallery-item">'
				+									'<a href='+ '"' + x.products[i].img2 + '"'+' itemprop="contentUrl" data-size="750x1050">'
				+									'<img src='+ '"' + x.products[i].img2 + '"'+' itemprop="thumbnail" alt="Image description" class="vertical-image img-rounded img-responsive" />'
				+									'</a>'
				+								'</figure>'
				+							'</div>'
				+						'</div>'
				...
				+					'<div class="card-description">'+ x.products[i].description +'</div>'
				+				'</div>'
				+			'</div>'
				+			'<div class="col-md-5">'
				+				'<div class="card card-plain">'
				+					'<div class="card-body">'
				+						'<h4 class="card-title text-center"><b>'+ x.products[i].titleProduct +'</b></h4>'
				+						'<br>'
				+						'<div class="card-description">'
				+							'<h6 class="d-inline-block" >Ngày sản xuất: &nbsp;</h6><p class="d-inline-block">'+ x.products[i].dateOfManufacture +'</p>'
				+							'<br>'
				+							'<h6 class="d-inline-block" >Nhà phân phối: &nbsp;</h6><p class="d-inline-block">'+ x.products[i].producer +'</p>'
				+							'<br>'
				+							'<h6 class="d-inline-block" >Khối lượng: &nbsp;</h6><p class="d-inline-block">'+ x.products[i].weight +'</p>'
				+							'<br>'
				+							'<h6 class="d-inline-block" >Giá: &nbsp;</h6><p class="d-inline-block">'+ x.products[i].price +'</p>'
				+							'<br>'
		...
		for (var i = 0; i < data.products.length; i++) {
			mainRow.append(
				'<div class="modal fade" id="detailedDishes' + '-' + data.products[i].id + '" tabindex="-1" role="dialog" aria-labelledby="modalDetail" aria-hidden="true">'
			+ '<div class="modal-dialog modal-notice" style="max-width: 65%;">'
			+ '<div class="modal-content">'
			+	'<div class="modal-header no-border-header">'
			+		'<h3 class="modal-title" id="modalDetail"><b>'+ data.products[i].title +'</b></h3>'
			+		'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>'
			+	'</div>'
			+	'<div class="modal-body">'
			+		'<div class="row">'
			...
			+							'<div class="row">'
			+								'<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-12 col-sm-12 gallery-item">'
			+									'<a href='+ '"' + data.products[i].img1 + '"'+' itemprop="contentUrl" data-size="750x1050">'
			+									'<img src='+ '"' + data.products[i].img1 + '"'+' itemprop="thumbnail" alt="Image description 1" class="vertical-image img-rounded img-responsive" />'
			+									'</a>'
			+								'</figure>'
			+								'<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-4 col-sm-5 gallery-item">'
			+									'<a href='+ '"' + data.products[i].img2 + '"'+' itemprop="contentUrl" data-size="750x1050">'
			+									'<img src='+ '"' + data.products[i].img2 + '"'+' itemprop="thumbnail" alt="Image description" class="vertical-image img-rounded img-responsive" />'
			+									'</a>'
			+								'</figure>'
			+							'</div>'
			+						'</div>'
			+					'</div>'
			+					'<h4 class="card-category"><b>Thông tin sản phẩm</b></h4>'
			+					'<div class="card-description">'+ data.products[i].description +'</div>'
			+				'</div>'
			+			'</div>'
			+			'<div class="col-md-5">'
			+				'<div class="card card-plain">'
			+					'<div class="card-body">'
			+						'<h4 class="card-title text-center"><b>'+ data.products[i].titleProduct +'</b></h4>'
			+						'<br>'
			+						'<div class="card-description">'
			+							'<h6 class="d-inline-block" >Ngày sản xuất: &nbsp;</h6><p class="d-inline-block">'+ data.products[i].dateOfManufacture +'</p>'
			+							'<br>'
			+							'<h6 class="d-inline-block" >Nhà phân phối: &nbsp;</h6><p class="d-inline-block">'+ data.products[i].producer +'</p>'
			+							'<br>'
			+							'<h6 class="d-inline-block" >Khối lượng: &nbsp;</h6><p class="d-inline-block">'+ data.products[i].weight +'</p>'
			+							'<br>'
			+							'<h6 class="d-inline-block" >Giá: &nbsp;</h6><p class="d-inline-block">'+ data.products[i].price +'</p>'
			+							'<br>'
			+							'<h6 class="d-inline-block" >Đánh giá: &nbsp;</h6>'
			+							'<p class="d-inline-block">'
			+								'<span class="fa fa-star checked"></span>'
	...
	if (typeof(data.then)  === 'function'){
		let loadProducts = data.then(x => {
			for (var i = 0; i < x.menu.length; i++) {
				...
				+												'<input type="checkbox" class="form-check-input" value="" checked="true">'
				...
				+									'<td class="td-product">'+ x.menu[i].name3 +'</td>'
				+									'<td class="td-number td-quantity">'
				+										x.menu[i].quantity3
				+										'<div class="btn-group">'
				+											'<button class="btn btn-sm btn-border btn-round">-</button>'
				...
				+										'<div class="form-check td-number">'
				+											'<label class="form-check-label">'
				+												'<input type="checkbox" class="form-check-input" value="" checked="false">'
				+												'<span class="form-check-sign"></span>'
				+											'</label>'
				+										'</div>'
				+									'</td>'
				...
				+										'<div class="form-check td-number">'
				+											'<label class="form-check-label">'
				+												'<input type="checkbox" class="form-check-input" value="" checked="true" disabled="true">'
				+												'<span class="form-check-sign"></span>'
				+											'</label>'
				+										'</div>'
				+									'</td>'
		...
		for (var i = 0; i < data.menu.length; i++) {
			mainRow.append(
				'<div class="modal fade" id="MonGa' + '-' + data.menu[i].id + '" tabindex="-1" role="dialog" aria-labelledby="nameModal" aria-hidden="true">'
			+		'<div class="modal-dialog" style="max-width: 700px;" role="document">'
			+			'<div class="modal-content">'
			+				'<div class="modal-header no-border-header">'
			+					'<h5 class="modal-title" id="nameModal"><b>'+ data.menu[i].title +'</b></h5>'
			+					'<button type="button" class="close" data-dismiss="modal" aria-label="Close">'
			+						'<span aria-hidden="true">&times;</span>'
			+					'</button>'
			+				'</div>'
			...
			+								'<tr>'
			+									'<td class="text-center">1</td>'
			+									'<td class="td-product">'+ data.menu[i].name1 +'</td>'
			+									'<td class="td-number td-quantity">'
			+										data.menu[i].quantity1
			+										'<div class="btn-group">'
			+											'<button class="btn btn-sm btn-border btn-round">-</button>'
			+											'<button class="btn btn-sm btn-border btn-round">+</button>'
			+										'</div>'
			...
			+								'<tr>'
			+									'<td class="text-center">2</td>'
			+									'<td class="td-product">'+ data.menu[i].name2 +'</td>'
			+									'<td class="td-number td-quantity">'
			+										data.menu[i].quantity2
			+										'<div class="btn-group">'
			+											'<button class="btn btn-sm btn-border btn-round">-</button>'
			+											'<button class="btn btn-sm btn-border btn-round">+</button>'
			+										'</div>'
			...
			+								'<tr>'
			+									'<td class="text-center">3</td>'
			+									'<td class="td-product">'+ data.menu[i].name3 +'</td>'
			+									'<td class="td-number td-quantity">'
			+										data.menu[i].quantity3
			+										'<div class="btn-group">'
			+											'<button class="btn btn-sm btn-border btn-round">-</button>'
			+											'<button class="btn btn-sm btn-border btn-round">+</button>'
			+										'</div>'
			...
			+								'<tr>'
			+									'<td class="text-center">4</td>'
			+									'<td class="td-product">'+ data.menu[i].name4 +'</td>'
			+									'<td class="td-number td-quantity">'
			+										data.menu[i].quantity4
			+										'<div class="btn-group">'
			+											'<button class="btn btn-sm btn-border btn-round">-</button>'
			+											'<button class="btn btn-sm btn-border btn-round">+</button>'
			+										'</div>'
			...
			+								'<tr>'
			+									'<td class="text-center">5</td>'
			+									'<td class="td-product">'+ data.menu[i].name5 +'</td>'
			+									'<td class="td-number td-quantity">'
			+										data.menu[i].quantity5
			+										'<div class="btn-group">'
			+											'<button class="btn btn-sm btn-border btn-round">-</button>'
			+											'<button class="btn btn-sm btn-border btn-round">+</button>'
			+										'</div>'
			...
			+								'<tr>'
			+									'<td class="text-center">6</td>'
			+									'<td class="td-product">'+ data.menu[i].name6 +'</td>'
			+									'<td class="td-number td-quantity">'
			+										data.menu[i].quantity6
			+										'<div class="btn-group">'
			+											'<button class="btn btn-sm btn-border btn-round">-</button>'
			+											'<button class="btn btn-sm btn-border btn-round">+</button>'
			+										'</div>'
			...
			+								'<tr>'
			+									'<td class="text-center">7</td>'
			+									'<td class="td-product">'+ data.menu[i].name7 +'</td>'
			+									'<td class="td-number td-quantity">'
			+										data.menu[i].quantity7
			+										'<div class="btn-group">'
			+											'<button class="btn btn-sm btn-border btn-round">-</button>'
			+											'<button class="btn btn-sm btn-border btn-round">+</button>'
			+										'</div>'
			...
			+					'<div class="divider"></div>'
			+					'<div class="right-side">'
			+						'<button type="button" class="btn btn-danger btn-magnify btn-link" onClick="ChooseDishClick(&apos;' + 'CMonGa-' + data.menu[i].id+'&apos;)" data-dismiss="modal">Thêm vào giỏ hàng <i class="fa fa-cart-plus" style="font-size: 1.5vw"></i></button>'
			+					'</div>'
			+				'</div>'
			+			'</div>'
			+		'</div>'
...
function bindDataToHTMLDishRecommend() {
	...
	if (typeof(data.then)  === 'function'){
		let loadProducts = data.then(x => {
			for (var i = 0; i < x.products[i].recommendDish.length; i++) {
				mainRow.append(
				...
				+				'<img src="'+x.products[i].recommendDish[i].img+'" class="img">'
				+			'</div>'
				+			'<div class="card-body text-center">'
				+				'<h5 class="card-title">'
				+					x.products[i].recommendDish[i].name
				+				'</h5>'
				+				'<div class="card-description">'
				+					x.products[i].recommendDish[i].description
				+				'</div>'
				+				'<hr>'
				+				'<div class="card-footer">'
				+					'<button id="CMonGa' + '-' + x.menu[i].id + '" type="button" class="btn btn-outline-primary btn-round" data-toggle="modal" data-target="#MonGa' + '-' + x.products[i].recommendDish[i].id+'">Chọn món</button>'
				+				'</div>'
				+			'</div>'
				+		'</div>'
				+	'</div>'
		...
		for (var i = 0; i < data.products[i].recommendDish.length; i++) {
			...
			+		'<div class="card card-blog">'
			+			'<div class="card-image">'
			+				'<img src="'+data.products[i].recommendDish[i].img+'" class="img">'
			+			'</div>'
			+			'<div class="card-body text-center">'
			+				'<h5 class="card-title">'
...
function addToCartDish(id) {
	if (typeof(data.then)  === 'function'){
		...
		for (var i = 0; i < data.menu.length; i++){
			if (data.menu[i].id == id){
				data.cart[0].menu.push(data.menu[i]);
			}
		}
	...
	if (typeof(data.then)  === 'function'){
		...
		for (var i = 0; i < data.products.length; i++){
			if (data.products[i].id == id){
				data.cart[0].product.push(data.products[i]);
			}
		}
		var len = data.cart[0].menu.length + data.cart[0].product.length;
		console.log(data.cart);
...
function initHeo() {
  ...
  function getAmountForCartHeo() {
	var len = data.cart[0].menu.length + data.cart[0].product.length;
	document.getElementById('cartAmount').innerText = len;
	console.log(len);
  };
function bindDataToHTMLHeo() {
	let mainRow = $('#main-product-row');
		for (var i = 8; i < data.products.length; i++) {
			mainRow.append('<div class="col-md-3" id='+ data.products[i].id+'><div class="card card-product card-plain"><div class="card-image">'
				+ '<a href="#" data-toggle="modal" data-target="#detailedDishes' + '-' + data.products[i].id + '">'
				+ '<img src="' + data.products[i].img + '" alt="Rounded Image" class="img-rounded img-responsive">'
				+ '</a>'
...
function bindDataToHTMLDetailHeo() {
	let mainRow = $('#loadDetailedDishes');
		for (var i = 8; i < data.products.length; i++) {
			mainRow.append(
				'<div class="modal fade" id="detailedDishes' + '-' + data.products[i].id + '" tabindex="-1" role="dialog" aria-labelledby="modalDetail" aria-hidden="true">'
			...
			+ '<div class="modal-content">'
			+	'<div class="modal-header no-border-header">'
			+		'<h3 class="modal-title" id="modalDetail"><b>'+ data.products[i].name +'</b></h3>'
			+		'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>'
			+	'</div>'
			+	'<div class="modal-body">'
			+		'<div class="row">'
			...
			+							'<div class="row">'
			+								'<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-12 col-sm-12 gallery-item">'
			+									'<a href='+ '"' + data.products[i].img + '"'+' itemprop="contentUrl" data-size="750x1050">'
			+									'<img src='+ '"' + data.products[i].img + '"'+' itemprop="thumbnail" alt="Image description 1" class="vertical-image img-rounded img-responsive" />'
			+									'</a>'
			+								'</figure>'
			+								'<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-4 col-sm-5 gallery-item">'
			+									'<a href='+ '"' + data.products[i].img + '"'+' itemprop="contentUrl" data-size="750x1050">'
			+									'<img src='+ '"' + data.products[i].img + '"'+' itemprop="thumbnail" alt="Image description" class="vertical-image img-rounded img-responsive" />'
			+									'</a>'
			+								'</figure>'
			+							'</div>'
			+						'</div>'
			+					'</div>'
			+					'<h4 class="card-category"><b>Thông tin sản phẩm</b></h4>'
			+					'<div class="card-description"> Đang cập nhật</div>'
			+				'</div>'
			+			'</div>'
			+			'<div class="col-md-5">'
			+				'<div class="card card-plain">'
			+					'<div class="card-body">'
			+						'<h4 class="card-title text-center"><b>'+ data.products[i].name +'</b></h4>'
			+						'<br>'
			+						'<div class="card-description">'
			+							'<h6 class="d-inline-block" >Ngày sản xuất: &nbsp;</h6><p class="d-inline-block">Đang cập nhật</p>'
			+							'<br>'
			+							'<h6 class="d-inline-block" >Nhà phân phối: &nbsp;</h6><p class="d-inline-block">Đang cập nhật</p>'
			+							'<br>'
			+							'<h6 class="d-inline-block" >Khối lượng: &nbsp;</h6><p class="d-inline-block">Đang cập nhật</p>'
			+							'<br>'
			+							'<h6 class="d-inline-block" >Giá: &nbsp;</h6><p class="d-inline-block">'+ data.products[i].price +'</p>'
			+							'<br>'
			+							'<h6 class="d-inline-block" >Đánh giá: &nbsp;</h6>'
...
function initGa() {
  ...
  function getAmountForCartGa() {
	var len = data.cart[0].menu.length + data.cart[0].product.length;
	document.getElementById('cartAmount').innerText = len;
	console.log(len);
  };
function bindDataToHTMLGa() {
	let mainRow = $('#main-product-row');
		for (var i = 0; i < data.products.length - 8; i++) {
			mainRow.append('<div class="col-md-3" id='+ data.products[i].id+'><div class="card card-product card-plain"><div class="card-image">'
				+ '<a href="#" data-toggle="modal" data-target="#detailedDishes' + '-' + data.products[i].id + '">'
				+ '<img src="' + data.products[i].img + '" alt="Rounded Image" class="img-rounded img-responsive">'
				+ '</a>'
...
function bindDataToHTMLDetailGa() {
	let mainRow = $('#loadDetailedDishes');
		for (var i = 0; i < data.products.length - 8; i++) {
			mainRow.append(
				'<div class="modal fade" id="detailedDishes' + '-' + data.products[i].id + '" tabindex="-1" role="dialog" aria-labelledby="modalDetail" aria-hidden="true">'
