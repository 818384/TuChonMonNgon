...
function bindDataToHTMLMyCartMenu() {
	let mainRow = $('#myCartMenu');
        ...
        +					'</tr>'
        +          '<tr>'
        +           '<div id="cookingInstructions'+i+'" role="tablist" aria-multiselectable="true">'
        +              '<div class="card no-transition">'
        +                '<div class="card-header card-collapse" role="tab" id="guide'+i+'">'
        +                  '<h5 class="panel-title">'
        +                    '<a class="collapsed" data-toggle="collapse" data-parent="#cookingInstructions'+i+'" href="#collapseGuide'+i+'" aria-expanded="false" aria-controls="collapseGuide'+i+'">'
        +                      'Hướng dẫn chi tiết cách nấu'
        +                      '<i class="nc-icon nc-minimal-down"></i>'
        +                    '</a>'
        +                  '</h5>'
        +                '</div>'
        +                '<div id="collapseGuide'+i+'" class="collapse" role="tabpanel" aria-labelledby="guide'+i+'">'
        +                  '<div class="card-body">'
        +                    '<dl>'
        ...
        +          '</tr>'
				...
				+							'<button onClick="deleteItemGH(\'menu\', '+data.cart[0].menu[i].id+')" type="button" data-toggle="tooltip" data-placement="top" title data-original-title="Hủy món" class="btn btn-danger btn-sm" style="font-size: 1vw">Hủy món này</button>'
				+						'</td>'
				+					'</tr>'
				+				'</tbody>'
				+			'</table>'
