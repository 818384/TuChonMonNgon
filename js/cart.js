...
function bindDataToHTMLMyCartMenu() {
	let mainRow = $('#myCartMenu');
		for (var i = 0; i < data.cart.menu.length; i++) {
			mainRow.append(
						'<h3 class="card-category"><strong>' + x.cart.menu[i].name + '</strong></h3>'
				+		'<br>'
				...
				+						'<td class="text-center">' + x.cart.menu[i].name1 + '</td>'
				+						'<td class="td-number td-quantity">'
				+							x.cart.menu[i].quantity1 + '&nbsp;&nbsp;'
				+							'<div class="btn-group">'
				+								'<button class="btn btn-sm btn-border btn-round">-</button>'
				+								'<button class="btn btn-sm btn-border btn-round">+</button>'
				+							'</div>'
				+						'</td>'
				+						'<td>' + x.cart.menu[i].price1 + '<small> VND</small></td>'
				...
				+						'<td class="text-center">' + x.cart.menu[i].name2 + '</td>'
				+						'<td class="td-number td-quantity">'
				+							x.cart.menu[i].quantity2 + '&nbsp;&nbsp;'
				+							'<div class="btn-group">'
				+								'<button class="btn btn-sm btn-border btn-round">-</button>'
				+								'<button class="btn btn-sm btn-border btn-round">+</button>'
				+							'</div>'
				+						'</td>'
				+						'<td>' + x.cart.menu[i].price2 + '<small> VND</small></td>'
				+						'<td class="td-actions text-center">'
				+							'<button type="button" data-toggle="tooltip" data-placement="top" title data-original-title="Xóa" class="btn btn-danger btn-link btn-sm">'
				+								'<i class="fa fa-times" style="font-size: 1.5vw"></i>'
				+							'</button>'
				...
				+						'<td class="text-center">' + x.cart.menu[i].name3 + '</td>'
				+						'<td class="td-number td-quantity">'
				+							x.cart.menu[i].quantity3 + '&nbsp;&nbsp;'
				+							'<div class="btn-group">'
				+								'<button class="btn btn-sm btn-border btn-round">-</button>'
				+								'<button class="btn btn-sm btn-border btn-round">+</button>'
				+							'</div>'
				+						'</td>'
				+						'<td>' + x.cart.menu[i].price3 + '<small> VND</small></td>'
				+						'<td class="td-actions text-center">'
				...
				+						'<td class="text-center">' + x.cart.menu[i].name4 + '</td>'
				+						'<td class="td-number td-quantity">'
				+							x.cart.menu[i].quantity4 + '&nbsp;&nbsp;'
				+							'<div class="btn-group">'
				+								'<button class="btn btn-sm btn-border btn-round">-</button>'
				+								'<button class="btn btn-sm btn-border btn-round">+</button>'
				+							'</div>'
				+						'</td>'
				+						'<td>' + x.cart.menu[i].price4 + '<small> VND</small></td>'
				+						'<td class="td-actions text-center">'
				+							'<button type="button" data-toggle="tooltip" data-placement="top" title data-original-title="Mua lại" class="btn btn-primary btn-link btn-sm">'
				+								'<i class="fa fa-cart-arrow-down" style="font-size: 1.5vw"></i>'
				+							'</button>'
				...
				+						'<td class="text-center">' + x.cart.menu[i].name5 + '</td>'
				+						'<td class="td-number td-quantity">'
				+							x.cart.menu[i].price5 + '&nbsp;&nbsp;'
				+							'<div class="btn-group">'
				+								'<button class="btn btn-sm btn-border btn-round">-</button>'
				+								'<button class="btn btn-sm btn-border btn-round">+</button>'
				+							'</div>'
				+						'</td>'
				+						'<td>' + x.cart.menu[i].price5 + '<small> VND</small></td>'
				+						'<td class="td-actions text-center">'
				+							'<button type="button" data-toggle="tooltip" data-placement="top" title data-original-title="Mua lại" class="btn btn-primary btn-link btn-sm">'
				+								'<i class="fa fa-cart-arrow-down" style="font-size: 1.5vw"></i>'
				+							'</button>'
				...
				+						'<td class="text-center">' + x.cart.menu[i].name6 + '</td>'
				+						'<td class="td-number td-quantity">'
				+							x.cart.menu[i].quantity6 + '&nbsp;&nbsp;'
				+							'<div class="btn-group">'
				+								'<button class="btn btn-sm btn-border btn-round">-</button>'
				+								'<button class="btn btn-sm btn-border btn-round">+</button>'
				+							'</div>'
				+						'</td>'
				+						'<td>' + x.cart.menu[i].price6 + '<small> VND</small></td>'
				+						'<td class="td-actions text-center">'
				+							'<button type="button" data-toggle="tooltip" data-placement="top" title data-original-title="Xóa" class="btn btn-danger btn-link btn-sm">'
				+								'<i class="fa fa-times" style="font-size: 1.5vw"></i>'
				+							'</button>'
				...
				+						'<td class="text-center">' + x.cart.menu[i].name7 + '</td>'
				+						'<td class="td-number td-quantity">'
				+							x.cart.menu[i].quantity7 + '&nbsp;&nbsp;'
				+							'<div class="btn-group">'
				+								'<button class="btn btn-sm btn-border btn-round">-</button>'
				+								'<button class="btn btn-sm btn-border btn-round">+</button>'
				+							'</div>'
				+						'</td>'
				+						'<td>' + x.cart.menu[i].price7 + '<small> VND</small></td>'
				+						'<td class="td-actions text-center">'
				+							'<button type="button" data-toggle="tooltip" data-placement="top" title data-original-title="Xóa" class="btn btn-danger btn-link btn-sm">'
				+								'<i class="fa fa-times" style="font-size: 1.5vw"></i>'
				+							'</button>'
